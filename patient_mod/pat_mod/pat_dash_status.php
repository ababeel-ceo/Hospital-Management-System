...
// -------------Appointmrnt coding section------------------------------//
    $no=0;
     $sql= "SELECT * FROM `appoinment` WHERE pat_id = $sid";
...
// ----------------------Hospital name Generation COde--------------------//
// $sql2= "SELECT * FROM `doctor` WHERE doctor_id = $doc_id";
// $r2 = mysqli_query($con,$sql2);


// while($row2=mysqli_fetch_assoc($r2))
// {
// $doc_name=$row2['doctor_name'];
// }
