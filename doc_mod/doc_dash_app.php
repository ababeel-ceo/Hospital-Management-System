  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
       ...
       <?php 
        ...
        // Appoinment  coding //
        $ap_q = "SELECT * FROM `appoinment` WHERE doc_id = $i AND status='pending'";
        $no=0;
        ...
        if($c)
        {
          while($app_row = mysqli_fetch_assoc($app))
          {
                ...
                echo " <td> <input type='submit' value='Accept' value=".$app_row['pat_id']." name='sbt' /> </td>  </tr> ";
          ...
          echo"  <tr> <td colspan=4 ><h4> No Appoinments are available </h4> </tr>";
