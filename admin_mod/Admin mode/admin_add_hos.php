    ...
    <div class="nav-wrapper d-flex align-items-center justify-content-between">
      <ul class="nav nav-pills d-none d-md-flex" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
          <a class="nav-link active" id="pills-company-tab" data-toggle="pill" href="admin_add_hos.php" role="tab" aria-controls="pills-company" aria-selected="true">ADD HOSPITAL</a>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content " id="pills-tabContent">
      <div class="tab-pane fade show active" id="pills-company" role="tabpanel" aria-labelledby="pills-company-tab">
        <div class="container-fluid">
          <label class="mb-3 font-weight-bold h4">Enter Hospital ID</label>

          <div  class="form-group">
          <form action=""method="post">

            <input type="number" class="form-control" name="hos_id"><br><br>

            <div class="text-center">
            <input type="submit" value="Add Hospital" class="btn btn-secondary" name="add">
          </div>
...
if(isset($_POST['add']))
{
    ...
    echo '<script>alert(" Plz enter ID")</script>';
    }
}
?>
...
{
  session_destroy();
  header('location:admin_add_hos.php');
}
